...
\textbf{SKILLS:} Git, Google Cloud, Pandas, NoSQL, MongoDB, Parse, Maven, Linux\bigskip\\
% -------------------------
%         education 
% -------------------------
\noindent
...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=5pt]
	...
	%\item Collaborated with a team to create an AI player program in Java to compete in the MIT Battlecode tournament.
	\item Created a Python web application on Google Cloud’s App Engine using Google’s Vision API to automatically generate accessible HMTL image tags for uploaded photos.
