...
%         Skills
% ----------------------------------
\textbf{LANGUAGES:} Java, JavaScript, Python, CSS, HTML, SQL, C, Haskell\medskip \\ %bash
\textbf{SKILLS:} Git, React, Node.js, Express, jQuery, Google Cloud Platform, MongoDB, Bootstrap, Maven
% pandas
\bigskip\\
% -------------------------
%         education 
...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=5pt]
	...
	\item Created a web application in Python on Google Cloud’s App Engine using the Vision API to automatically generate accessible HMTL image tags for uploaded photos.
