...
%\item[\textbf{LANGUAGES:}] Python, JavaScript, Java, CSS, HTML5, SQL, C,  Haskell
%\end{description}
% Airship
\textbf{LANGUAGES:} Python,  Java, SQL, JavaScript, CSS, HTML5, C, Bash, Haskell\medskip \\
\textbf{SKILLS:} Git, Google Cloud, NoSQL, MongoDB, Parse, Pandas, Linux\bigskip\\
% -------------------------
%         education 1
% -------------------------
%\noindent
...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=5pt]
	%\item Integrated front-end and back-end services to allow patients to share personal information with their medical providers through a telemedicine web application using Node.js and MongoDB.
