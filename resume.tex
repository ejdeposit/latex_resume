...
\item[\textbf{LANGUAGES:}] Python, JavaScript (proficient); C, Java, Haskell, SQL (working knowledge)
\end{description}
% -----------------------
%         projects
% -----------------------
...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=5pt]
	...
	\item Implemented a constraint satisfaction algorithm (AC-3) to solve Star Battle logic puzzles.
\end{itemize} 
\smallskip
...
\begin{itemize}[leftmargin=*, itemsep=0pt, topsep=5pt]
	...
	\item Integrated Google Cloud services, including the Maps API too allow users to find nearby pharmaceutical services.
\end{itemize}
